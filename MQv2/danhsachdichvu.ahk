...
Tatcadichvu := ["", "Cạo vôi răng","Trám răng","Nội nha","Nhổ răng","Răng sứ","Răng tháo lắp","Implant","Chỉnh nha","Tẩy trắng răng","Ghép huyết tương","Ghép xương","Bôi SDF","Cắt thắng lưỡi"]
...
danhMucImplant := ["Implant Dio", "Implant Helix", "Implant Strauman", "Implant ETK", "Abutment Dio", "Abutment Dio Zirconia", "Abutment Helix", "Abutment Helix Zirconia", "Abutment Strauman", "Abutment Strauman Zirconia", "Abutment ETK"]
