...
danhMucDichVu["Abutment Dio"] := ["K08.1", "ABU001", "T05135", "implant", "03", 1, 2]
danhMucDichVu["Abutment Dio Zirconia"] := ["K08.1", "ABU004", "T05141", "implant", "03", 1, 2]
danhMucDichVu["Abutment Helix"] := ["K08.1", "ABU002", "T05137", "implant", "03", 1, 2]
danhMucDichVu["Abutment Helix Zirconia"] := ["K08.1", "ABU005", "T05143", "implant", "03", 1, 2]
danhMucDichVu["Abutment Strauman"] := ["K08.1", "ABU003", "T05139", "implant", "03", 1, 2]
danhMucDichVu["Abutment Strauman Zirconia"] := ["K08.1", "ABU006", "T05145", "implant", "03", 1, 2]
danhMucDichVu["Abutment ETK"] := ["K08.1", "ABUT02.1", "T05579", "implant", "03", 1, 2]
danhMucDichVu["Abutment ETK Zirconia"] := ["K08.1", "ABUT02.1", "T05579", "implant", "03", 1, 2]
...
danhMucDichVu["Điều trị tủy răng số 6 hàm dưới"] := ["K04", "16.44.2", "P11655248", "noinha", "17", 25, 45]
danhMucDichVu["Điều trị tủy răng số 7 hàm trên"] := ["K04", "16.44.4.1", "P11655248", "noinha", "03", 25, 45]
danhMucDichVu["Điều trị tủy răng số 7 hàm dưới"] := ["K04", "16.44.2.1", "P11655248", "noinha", "17", 25, 45]
...
danhMucDichVu["Điều trị tủy răng số 1 gây mê"] := ["K04", "RHM8", "P11655248", "noinha", "03", 15, 25]
danhMucDichVu["Điều trị tủy răng số 2 gây mê"] := ["K04", "RHM10", "P11655248", "noinha", "03", 15, 25]
danhMucDichVu["Điều trị tủy răng số 3 gây mê"] := ["K04", "RHM12", "P11655248", "noinha", "03", 15, 25]
danhMucDichVu["Điều trị tủy răng số 4 gây mê"] := ["K04", "RHM14", "P11655248", "noinha", "03", 15, 25]
danhMucDichVu["Điều trị tủy răng số 5 gây mê"] := ["K04", "RHM16", "P11655248", "noinha", "03", 15, 25]
danhMucDichVu["Điều trị tủy răng số 6 hàm trên gây mê"] := ["K04", "RHM21", "P11655248", "noinha", "03", 20, 45]
danhMucDichVu["Điều trị tủy răng số 6 hàm dưới gây mê"] := ["K04", "RHM20", "P11655248", "noinha", "17", 20, 45]
danhMucDichVu["Điều trị tủy răng số 7 hàm trên gây mê"] := ["K04", "RHM24", "P11655248", "noinha", "03", 20, 45]
danhMucDichVu["Điều trị tủy răng số 7 hàm dưới gây mê"] := ["K04", "RHM23", "P11655248", "noinha", "17", 20, 45]
...
danhMucDichVu["Điều trị tủy lại răng số 1"] := ["K04.4", "16.61.8", "P11655248", "noinha", "03", 15, 30]
danhMucDichVu["Điều trị tủy lại răng số 2"] := ["K04.4", "16.61.8.1", "P11655248", "noinha", "03", 15, 30]
danhMucDichVu["Điều trị tủy lại răng số 3"] := ["K04.4", "16.61.8.2", "P11655248", "noinha", "03", 15, 30]
danhMucDichVu["Điều trị tủy lại răng số 4"] := ["K04.4", "16.61.7", "P11655248", "noinha", "03", 15, 30]
danhMucDichVu["Điều trị tủy lại răng số 5"] := ["K04.4", "16.61.7.1", "P11655248", "noinha", "03", 15, 30]
danhMucDichVu["Điều trị tủy lại răng số 6"] := ["K04.4", "16.61.3", "P11655248", "noinha", "03", 20, 45]
danhMucDichVu["Điều trị tủy lại răng số 7"] := ["K04.4", "16.61.3.1", "P11655248", "noinha", "03", 20, 45]

danhMucDichVu["Điều trị tủy lại răng số 1 gây mê"] := ["K04.4", "RHM9", "P11655248", "noinha", "03", 10, 30]
danhMucDichVu["Điều trị tủy lại răng số 2 gây mê"] := ["K04.4", "RHM11", "P11655248", "noinha", "03", 10, 30]
danhMucDichVu["Điều trị tủy lại răng số 3 gây mê"] := ["K04.4", "RHM13", "P11655248", "noinha", "03", 10, 30]
danhMucDichVu["Điều trị tủy lại răng số 4 gây mê"] := ["K04.4", "RHM15", "P11655248", "noinha", "03", 10, 30]
danhMucDichVu["Điều trị tủy lại răng số 5 gây mê"] := ["K04.4", "RHM19", "P11655248", "noinha", "03", 10, 30]
danhMucDichVu["Điều trị tủy lại răng số 6 gây mê"] := ["K04.4", "RHM22", "P11655248", "noinha", "03", 10, 30]
...
danhMucDichVu["Tháo cầu răng"] := ["K02.1", "16.137", "T05249", "thaocao", "00", 1, 2]
danhMucDichVu["Tháo mão (chụp)"] := ["K02.1", "16.138", "T05249", "thaocao", "00", 1, 2]
