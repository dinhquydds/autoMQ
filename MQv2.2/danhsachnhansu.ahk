...
danhsachUser := ["Quý ND","Hoàng N", "Vi HT", "Tâm NTH","Phương NT","Sâm LT","Nguyên HT","Vinh TD","Pẹc NV", "Hạnh HTH", "Luyến VT"]
...
thongTinNhanSu["Hạnh HTH"] := ["hanhhth", "123456", "0481"] ; 
...
thongTinNhanSu["Trang LTT"] := ["trangltt","123456", "0482"] ; "Lâm Thị Thu Trang"
